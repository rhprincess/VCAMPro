...
object SakuraTheme: BaseTheme {

    private val primaryLight = Color(0xFF8F4951)
    private val onPrimaryLight = Color(0xFFFFFFFF)
    private val primaryContainerLight = Color(0xFFFFDADB)
    private val onPrimaryContainerLight = Color(0xFF3B0711)
    private val secondaryLight = Color(0xFF765658)
    private val onSecondaryLight = Color(0xFFFFFFFF)
    private val secondaryContainerLight = Color(0xFFFFDADB)
    private val onSecondaryContainerLight = Color(0xFF2C1517)
    ...
    private val inversePrimaryLight = Color(0xFFFFB2B8)
    ...
    private val primaryLightMediumContrast = Color(0xFF6D2F37)
    private val onPrimaryLightMediumContrast = Color(0xFFFFFFFF)
    private val primaryContainerLightMediumContrast = Color(0xFFA95F66)
    private val onPrimaryContainerLightMediumContrast = Color(0xFFFFFFFF)
    private val secondaryLightMediumContrast = Color(0xFF583B3D)
    private val onSecondaryLightMediumContrast = Color(0xFFFFFFFF)
    private val secondaryContainerLightMediumContrast = Color(0xFF8E6C6E)
    private val onSecondaryContainerLightMediumContrast = Color(0xFFFFFFFF)
    private val tertiaryLightMediumContrast = Color(0xFF583E17)
    private val onTertiaryLightMediumContrast = Color(0xFFFFFFFF)
    private val tertiaryContainerLightMediumContrast = Color(0xFF8F6F44)
    ...
    private val onSurfaceLightMediumContrast = Color(0xFF22191A)
    private val surfaceVariantLightMediumContrast = Color(0xFFF4DDDE)
    private val onSurfaceVariantLightMediumContrast = Color(0xFF4E3F40)
    private val outlineLightMediumContrast = Color(0xFF6C5B5C)
    private val outlineVariantLightMediumContrast = Color(0xFF887677)
    private val scrimLightMediumContrast = Color(0xFF000000)
    private val inverseSurfaceLightMediumContrast = Color(0xFF382E2E)
    private val inverseOnSurfaceLightMediumContrast = Color(0xFFFFEDED)
    private val inversePrimaryLightMediumContrast = Color(0xFFFFB2B8)
    private val surfaceDimLightMediumContrast = Color(0xFFE7D6D6)
    ...
    private val surfaceContainerLowLightMediumContrast = Color(0xFFFFF0F0)
    private val surfaceContainerLightMediumContrast = Color(0xFFFCEAEA)
    private val surfaceContainerHighLightMediumContrast = Color(0xFFF6E4E4)
    private val surfaceContainerHighestLightMediumContrast = Color(0xFFF0DEDF)

    private val primaryLightHighContrast = Color(0xFF440E18)
    private val onPrimaryLightHighContrast = Color(0xFFFFFFFF)
    private val primaryContainerLightHighContrast = Color(0xFF6D2F37)
    private val onPrimaryContainerLightHighContrast = Color(0xFFFFFFFF)
    private val secondaryLightHighContrast = Color(0xFF341B1E)
    private val onSecondaryLightHighContrast = Color(0xFFFFFFFF)
    private val secondaryContainerLightHighContrast = Color(0xFF583B3D)
    private val onSecondaryContainerLightHighContrast = Color(0xFFFFFFFF)
    private val tertiaryLightHighContrast = Color(0xFF321E00)
    private val onTertiaryLightHighContrast = Color(0xFFFFFFFF)
    private val tertiaryContainerLightHighContrast = Color(0xFF583E17)
    ...
    private val surfaceVariantLightHighContrast = Color(0xFFF4DDDE)
    private val onSurfaceVariantLightHighContrast = Color(0xFF2D2122)
    private val outlineLightHighContrast = Color(0xFF4E3F40)
    private val outlineVariantLightHighContrast = Color(0xFF4E3F40)
    ...
    private val inversePrimaryLightHighContrast = Color(0xFFFFE6E7)
    private val surfaceDimLightHighContrast = Color(0xFFE7D6D6)
    ...
    private val surfaceContainerLowLightHighContrast = Color(0xFFFFF0F0)
    private val surfaceContainerLightHighContrast = Color(0xFFFCEAEA)
    private val surfaceContainerHighLightHighContrast = Color(0xFFF6E4E4)
    private val surfaceContainerHighestLightHighContrast = Color(0xFFF0DEDF)

    private val primaryDark = Color(0xFFFFB2B8)
    private val onPrimaryDark = Color(0xFF561D25)
    private val primaryContainerDark = Color(0xFF72333A)
    private val onPrimaryContainerDark = Color(0xFFFFDADB)
    private val secondaryDark = Color(0xFFE5BDBF)
    private val onSecondaryDark = Color(0xFF44292B)
    ...
    private val tertiaryContainerDark = Color(0xFF5D421B)
    ...
    private val primaryDarkMediumContrast = Color(0xFFFFB8BE)
    private val onPrimaryDarkMediumContrast = Color(0xFF34030C)
    private val primaryContainerDarkMediumContrast = Color(0xFFCA7A82)
    private val onPrimaryContainerDarkMediumContrast = Color(0xFF000000)
    private val secondaryDarkMediumContrast = Color(0xFFEAC1C3)
    private val onSecondaryDarkMediumContrast = Color(0xFF261012)
    private val secondaryContainerDarkMediumContrast = Color(0xFFAC888A)
    private val onSecondaryContainerDarkMediumContrast = Color(0xFF000000)
    private val tertiaryDarkMediumContrast = Color(0xFFECC492)
    private val onTertiaryDarkMediumContrast = Color(0xFF231300)
    private val tertiaryContainerDarkMediumContrast = Color(0xFFAE8B5D)
    ...
    private val surfaceVariantDarkMediumContrast = Color(0xFF524344)
    private val onSurfaceVariantDarkMediumContrast = Color(0xFFDBC6C6)
    private val outlineDarkMediumContrast = Color(0xFFB29E9F)
    private val outlineVariantDarkMediumContrast = Color(0xFF917F7F)
    private val scrimDarkMediumContrast = Color(0xFF000000)
    private val inverseSurfaceDarkMediumContrast = Color(0xFFF0DEDF)
    private val inverseOnSurfaceDarkMediumContrast = Color(0xFF312828)
    private val inversePrimaryDarkMediumContrast = Color(0xFF74343C)
    private val surfaceDimDarkMediumContrast = Color(0xFF1A1112)
    private val surfaceBrightDarkMediumContrast = Color(0xFF413737)
    private val surfaceContainerLowestDarkMediumContrast = Color(0xFF140C0D)
    private val surfaceContainerLowDarkMediumContrast = Color(0xFF22191A)
    private val surfaceContainerDarkMediumContrast = Color(0xFF271D1E)
    private val surfaceContainerHighDarkMediumContrast = Color(0xFF312828)
    private val surfaceContainerHighestDarkMediumContrast = Color(0xFF3D3233)

    private val primaryDarkHighContrast = Color(0xFFFFF9F9)
    private val onPrimaryDarkHighContrast = Color(0xFF000000)
    private val primaryContainerDarkHighContrast = Color(0xFFFFB8BE)
    ...
    private val secondaryContainerDarkHighContrast = Color(0xFFEAC1C3)
    ...
    private val tertiaryContainerDarkHighContrast = Color(0xFFECC492)
    ...
    private val surfaceVariantDarkHighContrast = Color(0xFF524344)
    private val onSurfaceVariantDarkHighContrast = Color(0xFFFFF9F9)
    private val outlineDarkHighContrast = Color(0xFFDBC6C6)
    private val outlineVariantDarkHighContrast = Color(0xFFDBC6C6)
    ...
    private val inversePrimaryDarkHighContrast = Color(0xFF4E161F)
    private val surfaceDimDarkHighContrast = Color(0xFF1A1112)
    private val surfaceBrightDarkHighContrast = Color(0xFF413737)
    private val surfaceContainerLowestDarkHighContrast = Color(0xFF140C0D)
    private val surfaceContainerLowDarkHighContrast = Color(0xFF22191A)
    private val surfaceContainerDarkHighContrast = Color(0xFF271D1E)
    private val surfaceContainerHighDarkHighContrast = Color(0xFF312828)
    private val surfaceContainerHighestDarkHighContrast = Color(0xFF3D3233)
